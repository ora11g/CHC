...
namespace CHCIS.P.API
{
    public class BootStrapper
    {
        ...
        private const string ConnectionString = "CHCIS.P.API";
        ...
        /// <returns></returns>
        private static IUnityContainer BuildContainer(string connectionString)
        {
        ...
        {
            var unityContainer = BuildContainer(ConnectionString);
        }
    }
}